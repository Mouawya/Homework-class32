...
// My explanation:
// The problem is solved because we are using promises.
//The promise moves from the state of 'Pending' to either 'Resolved' or 'Rejected' and then it stops.
//In this exercise when the dice rolls off the table, the promise state is rejection and therefor the promise stops and does not return the success value.
